...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/orange?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    ...
    //模块名称，用于组成包名
    public static String modelName = "shop";
